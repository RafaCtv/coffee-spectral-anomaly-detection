...
// Máscara de nuvem com Cloud Score+ (funciona em todo o período, inclui pós-2022)
var csPlus = ee.ImageCollection('GOOGLE/CLOUD_SCORE_PLUS/V1/S2_HARMONIZED');
var QA_BAND = 'cs_cdf';
var CLEAR_THRESHOLD = 0.6;  // probabilidade mínima de pixel limpo (0.5-0.65 típico)
...
var colecao = ee.ImageCollection('COPERNICUS/S2_SR_HARMONIZED')
                ...
                .map(function(imagem) {
                  return imagem.updateMask(imagem.select(QA_BAND).gte(CLEAR_THRESHOLD));
                });
